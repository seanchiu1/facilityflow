...
| 27 | `supabase_demo_seed.sql` | **Seed (optional)** | Steps 0, 1, 9, 13 + manager/vendor accounts | Appointment workflow demo data |
| 28 | `supabase_demo_seed_projects.sql` | **Seed (optional)** | Step 27 + Steps 16, 17, 22, 23 + all 5 demo accounts | Project/vendor collaboration demo data |
